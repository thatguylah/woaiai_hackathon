...
async def generate_image(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    image = client.text_to_image(generated_prompt)
...
def main(dev_mode) -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            IMAGE_PURPOSE: [MessageHandler(filters.TEXT, get_image_purpose)],
            SELECTED_THEME: [MessageHandler(filters.TEXT, select_theme)],
            SELECTED_IMAGE_DESIGN: [MessageHandler(filters.TEXT, select_image_design)],
            TEXT_TO_IMAGE_PROMPT: [MessageHandler(filters.TEXT, get_image_prompt)],
            GENERATED_IMAGE: [MessageHandler(filters.TEXT, generate_image)],
        },
